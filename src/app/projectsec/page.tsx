...
//   {
//     title: 'Shop.co',
//     description: 'A modern e-commerce platform with a sleek design and smooth animations, built with Next.js and Tailwind CSS.',
//     image: '/image1.png',
...
//   {
//     title: 'Agentia World',
//     description: 'An interactive AI agent platform with a sleek, modern design and smooth animations.',
//     image: '/agent.PNG',
...
//   return (
//     <section id="projectsec" className="relative py-32 px-4 sm:px-8 md:px-20 bg-[#0e0e0e] text-white overflow-hidden">
//       {/* Background Lights */}
//       <motion.div
//         initial={{ opacity: 0 }}
//         animate={{ opacity: 1 }}
...
//             Pro<span className="text-fuchsia-500 ">jects</span>
//           </h2>
