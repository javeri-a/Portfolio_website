...
// import { FaDribbble, FaGithub, FaLinkedinIn, FaBehance } from 'react-icons/fa';

// const socialIcons = [FaLinkedinIn, FaDribbble, FaGithub, FaBehance];
...
//       {/* Fixed Navbar */}
//       <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-10 py-6 bg-[#0c0c0c]/80 backdrop-blur-md text-sm border-b border-white/10 shadow-sm">
//         <div className="text-2xl font-bold tracking-wide">Mam Javeria</div>
...
//           ))}
//         </ul>
//         <button className="hidden md:block px-6 py-2 rounded-full bg-white text-black hover:bg-fuchsia-600 hover:text-white transition font-semibold shadow-sm">
//           Hire Me →
//         </button>
//       </nav>

//       {/* Hero Section */}
//       <section className="relative z-20 w-full px-6 md:px-24 py-28 pt-40">
...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-[#0c0c0c] text-white font-sans overflow-hidden">
      ...
      {/* Fixed Navbar */}
      <nav className="fixed top-0 left-0 w-full z-50 flex justify-between items-center px-10 py-6 bg-[#0c0c0c]/80 backdrop-blur-md text-sm border-b border-white/10 shadow-sm">
        <div className="text-2xl font-bold tracking-wide"> Javeria</div>
        <ul className="hidden md:flex gap-10 text-gray-400 font-medium">
          {['Home', 'About', 'Skills', 'Projects', 'Services', 'Contact'].map((item) => (
            <li key={item} className="hover:text-white transition cursor-pointer">
              {item}
