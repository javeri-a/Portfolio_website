    ...
    <section id ="aboutsec" className="relative z-10 w-full px-6 md:px-24 py-24 bg-[#0e0e0e] text-gray-300 overflow-hidden">
      ...
      >
        ...
        <p className="text-lg md:text-xl leading-relaxed text-gray-400 max-w-3xl mx-auto">
          ...
          Currently, I am expanding into <span className="text-pink-400 font-semibold">Python</span> and actively learning <span className="text-fuchsia-400 font-semibold">OpenAIs Agentic SDK</span> — diving deep into intelligent automation, autonomous workflows, and the next wave of AI-integrated frontends.
        </p>
